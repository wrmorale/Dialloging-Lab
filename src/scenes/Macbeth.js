class Macbeth extends Phaser.Scene {
    ...
    create() {
        ...
        this.macbeth = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'macbethpng').setOrigin(0, 1).setScale(.25);
        this.banquo = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'banquo').setOrigin(0, 1).setScale(.25);
